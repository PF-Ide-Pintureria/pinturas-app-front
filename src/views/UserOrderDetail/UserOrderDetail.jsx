        ...
        return (
            <div className="flex flex-col p-16">
                ...
                <div className="border border-solid rounded-b-lg">
                    ...
                    <div className="grid grid-cols-2 ">
                        {products.map((product) => {
                            return <div className="mb-9 flex">
                ...
                <div className="flex items-center justify-evenly">
                    ...
                    && <button
                    onClick={sendReview}
                    className="bg-indigo-800 rounded-xl w-56 h-12 m-8 text-white border-2 border-solid border-gray-300 shadow-md font-bold hover:bg-indigo-700 hover:text-yellow-200 transition-transform transform hover:transform hover:scale-105"> Opina sobre tu compra </button> }
                    <h1 className=" flex  font-semibold text-xl">Total compra: <p className="font-black pl-4">${detail.total}</p></h1>
                </div>
            </div>
        )
    } else {
