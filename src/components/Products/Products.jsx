  ...
  return (
    <div className="w-64 h-96  flex flex-col items-center text-secondary justify-center bg-tertiary rounded-3xl transition-transform duration-300 ease-in-out hover:scale-105">
      ...
      <div>
        ...
        >
          <p className="relative inline-flex items-center justify-center px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-blue-600 w-52 rounded-md group-hover:bg-opacity-0">
            Ver Producto
          </p>
        </NavLink>
      </div>
