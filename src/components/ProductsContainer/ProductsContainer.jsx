                            ...
                            <div className="gap-3">
                                ...
                                <div className="mb-5">  {/*       FILTER PRICE         */}
                                    ...
                                    <div className="text-lg flex flex-col flex-wrap">
                                        <h3
                                            className={`mt-1 no-underline text-sm ${(!low && high === 10000) ? "text-indigo-900" : "text-gray-400  hover:text-indigo-900 cursor-pointer transition-transform duration-300 ease-in-out hover:scale-110"
                                                } m-0`}
